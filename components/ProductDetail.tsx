          ...
          <div className="flex flex-col justify-center max-w-xl">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="mt-4">
                ...
                <p className="text-xs text-brandGraphite/90 font-light tracking-wide leading-relaxed">
                  Fazemos encomendas. Se você tem uma entidade para homenagear ou um fundamento que ainda não encontrou forma, entre em contato — desenvolvemos a estampa com o mesmo cuidado de toda a coleção.
                </p>
              </div>
            </div>
          </div>
